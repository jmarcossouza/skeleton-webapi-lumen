...
class ConfirmarEmailJob extends Job
{
    public $usuario;
    public $tries = 3; //Número máximo de tentativas
    public $queue = 'confirmar_email_mail'; //Nome da queue que será rodado.
    ...
    {
        Mail::to($this->usuario->email)->send(new ConfirmarEmailMail($this->usuario));
    }
}
